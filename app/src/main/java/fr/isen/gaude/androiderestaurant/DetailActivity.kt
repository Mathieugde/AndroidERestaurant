...
class DetailActivity : ToolActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.ingredientList.text = list
        var counter = 1
        ...
        val buttonMinus = binding.minusBtn
        val buttonPlus = binding.plusBtn
        binding.totalBtn.text = "Total : " + price + "€"

        buttonPlus.setOnClickListener {
            counter++
            totPrice = price.toFloat() * counter
            binding.counter.text = counter.toString()
            binding.totalBtn.text = "Total : " + totPrice.toString() + "€"
        }
        ...
        val buttonTot = binding.totalBtn
