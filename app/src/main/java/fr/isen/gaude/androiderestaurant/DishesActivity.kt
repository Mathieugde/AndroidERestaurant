...
import fr.isen.gaude.androiderestaurant.databinding.ActivityDishesBinding
...
class DishesActivity : ToolActivity() {
    ...
    private fun displayDishes(dishresult: List<DishModel>) {
        ...
        val recyclerview = binding.dishItem

        // this creates a vertical layout Manager
        recyclerview.layoutManager = LinearLayoutManager(this)

        binding.dishItem.layoutManager = LinearLayoutManager(this)
        binding.dishItem.adapter = DishAdapter(dishresult) {
