...
import fr.isen.gaude.androiderestaurant.databinding.FragmentRegisterBinding
import fr.isen.gaude.androiderestaurant.model.RegisterModel
...
class RegisterFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var buttonValidate = binding.validBtn
